...
- `affb4af` — Memory flush: remote monitoring session

---

## Tailscale Configuration Fix

**Time:** 01:25–01:30 CST  
**Issue:** Initial config patch used invalid `"mode": "on"` → schema validation failed
